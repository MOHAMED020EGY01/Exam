...
import { Book, FileText, Calendar, Pen, Trash, Plus, Eye, Download } from "lucide-react";
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button 
              variant="outline" 
              size="sm"
              onClick={() => onEditCourse(selectedNode.originalData)}
            >
            ...
            <Button 
              variant="destructive" 
              size="sm"
              onClick={() => onDeleteCourse(selectedNode.originalData)}
            >
      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <Button size="xs" onClick={() => onAddExam(selectedNode.originalData)}>
              ...
              {selectedNodeExams.map((exam: any) => (
                <div key={exam?.id || String(Math.random())} className="flex justify-between items-center p-3 hover:bg-muted/10 transition-colors text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="xs" variant="outline" onClick={() => onDownloadExam(exam)}>
