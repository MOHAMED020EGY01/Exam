...
export class QuestionService {
    ...
    static removeQuestion(
        ...
        return questions.filter((_: unknown, i: number) => i !== questionIndex);
    }
        ...
        return questions.map((q: Question, i: number) => {
            ...
            return {
                ...
                answers: q.answers.filter(
                    (_: unknown, ai: number) => ai !== answerIndex,
                ),
            };
        });
    }
    ...
    static updateAnswer<K extends keyof Answer>(
        ...
        return questions.map((q: Question, i: number) => {
            ...
            return {
                ...q,
                answers: q.answers.map((a: Answer, ai: number) => {
    ...
    static toggleCorrect(
        ...
        return questions.map((q: Question, i: number) => {
            ...
            if (!q.multiple) {
                newAnswers = q.answers.map((a: Answer, ai: number) => ({
                    ...a,
